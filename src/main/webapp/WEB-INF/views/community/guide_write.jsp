...
<div class="col-sm-10" style="margin-top: 15px;">
		<input class="form-control input-sm" type="text" id="guideTitle" name="guideTitle" 
	...
	<div class="col-sm-10">
	  ...
	  <textarea id="guideContent" name="guideContent"></textarea>
...
function goWrite(){
		...
		if($('#guideTitle').val().trim().length <=1 ){
			alert('제목을 입력해주세요');
			$('#guideTitle').focus();
			return
		}
		if($('#guideContent').val().trim().length <=1 ){
			alert('내용을 입력해주세요');
			$('#guideContent').focus();
			return
		}
