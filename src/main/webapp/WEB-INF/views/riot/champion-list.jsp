	...
	$.ajax({
		...
		success:function(res){
			...
			for(var champ of res){
				...
				html +='<img src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/champion/'+champ.championInfoId+'.png" width="80px">';
				html +='</a></div>';
	...
	$.ajax({
		...
		success:function(res){
			for(var i=0; i<20; i++){
				...
				$('#rankImg'+i).html('<img src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/champion/'+champ.championInfoId+'.png" width="60px" style="margin-left: 5px;">');
			}
		}
