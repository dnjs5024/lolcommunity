    ...
    <div style="float: left">
      <div class="row">
	    <div style="width: 150px" align="center">
	     	<img src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/champion/${champion.championInfoId}.png" width="150px">
...
function getSpell(spell){
	...
	if(type=='Q'){
		var html ='';
		html +='<img id="imageQ" src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/spell/'+imageId+'.png" onmouseover="getDes(1)">'
		$('.icon1').html(html);
		html ='';
	...
	if(type=='W'){
		var html ='';
		html +='<img id="imageW" src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/spell/'+imageId+'.png" onmouseover="getDes(2)">'
		$('.icon2').html(html);
		html ='';
	...
	if(type=='E'){
		var html ='';
		html +='<img id="imageE" src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/spell/'+imageId+'.png" onmouseover="getDes(3)">'
		$('.icon3').html(html);
		html ='';
	...
	if(type=='R'){
		var html ='';
		html +='<img id="imageR" src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/spell/'+imageId+'.png" onmouseover="getDes(4)">'
		$('.icon4').html(html);
		html ='';
	...
	if(type=='P'){
		var html ='';
		html +='<img id="imageP" src="http://ddragon.leagueoflegends.com/cdn/10.22.1/img/passive/'+imageId+'.png" onmouseover="getDes(0)">'
		$('.icon0').html(html);
		html ='';
