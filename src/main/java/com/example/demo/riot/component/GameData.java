...
public class GameData {
	...
	@Autowired
	private static RiotData rd;
	@Resource
	private static MatchInfoMapper mim;
	@Resource
	private static MatchGameInfoMapper mgim;
	@Resource
	private static RunePageMapper rpm;
	@Resource
	private static MatchItemSlotMapper mism;
	
	public static void sortValue(List<Map<String,Object>> list, String position) {
	...
	public static String getMatchData(String matchId) {
		...
		if(rMap.get("gameMode") == null || rMap.get("queueId") ==null) {
			return "게임모드나 큐아이디 음슴";
		}
		String gameMode = rMap.get("gameMode").toString();
		int queueId = (int)rMap.get("queueId");
		if(!gameMode.equals("CLASSIC") || queueId != 420) {
			return "솔랭아님";
		}
	...
	public static void main(String[] args) {
		MatchInfoVO miv = new MatchInfoVO();
